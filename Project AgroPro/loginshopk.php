...
<html>
<head>
	<title>Login as shopkeeper</title>
...
<section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
  ...
  <div class="row d-flex justify-content-center">
    ...
    <div class="col-md-6">
      ...
      <form class="text-center" action="loginshopk.php" method="post" >
        ...
        <div class="form-row mb-4">
          <div class="col">
            <!-- First name -->
            <input type="text" id="defaultRegisterFormFirstName" name="username" class="form-control" placeholder="User name">
          </div>
        </div>
        ...
        <!-- Social register -->
        <p>Dont have an account?<a href="registershopk.php"> Register</a></p>
