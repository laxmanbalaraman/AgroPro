...
<head>
   <title>registration as farmer</title>
...
<section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
  ...
  <div class="row d-flex justify-content-center">
    ...
    <div class="col-md-6">
      ...
      <form class="text-center" action="registerfarmer.php" method="post" action="#!">
        ...
        <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4">
          At least 8 characters, 1 digit and 1 capital letter
        </small>

        <input type="password" name="cpassword" id="defaultRegisterFormPassword" class="form-control" placeholder="Confirm Password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
          aria-describedby="defaultRegisterFormPasswordHelpBlock"> <br>


        <!-- Phone number -->
        <input type="number" id="defaultRegisterPhonePassword" class="form-control" placeholder="Phone number" name="phoneno"
        ...
        <a href="loginfarmer.php" >Sign Up</a>
...
<!--Section: Content-->
   ...
   if (isset($_POST['submit_btn'])) {
      ...
      if ($password == $cpassword) {
         ...
         $query = "select * from farmeruser where email='$email'";
         ...
         if ($uflag == 0 and $eflag == 0) {
            ...
            $query = "insert into  farmeruser values('$firstname','$lastname','$username','$hash','$email','$pno','$loc')";
